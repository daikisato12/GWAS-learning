...
### 使われる手法
基本的にはどれもそこまで変わらないが, サンプル数/SNP数の増加に伴い, 計算時間とメモリ使用量が膨大に増えてきたので, それを抑えつつ, 真のシグナルを捉えられるよう微調整が加えられてきたというイメージ. 量的形質なら`BOLT-LMM`, 2値形質 (疾患かどうか等) なら`SAIGE`がいいんじゃないかという印象.
#### Variant-baseモデル
